...
class FetchWebChapterScreen extends StatefulWidget {
  ...
  final void Function(FetcherResponse response)? onSaved;
...
class _FetchWebChapterScreenState extends State<FetchWebChapterScreen> {
  ...
  void _onSave() {
    try {
      ...
      final response = FetcherResponse(
        url: pageUrlController.text,
        title: titleController.text,
        chapterNumber: int.parse(chapterNumberController.text),
        content: contentController.text,
      );
      widget.onSaved?.call(response);
